...
def add_content(path_to_find, file, result_file, auto_mode):
    ...
    if file != "":
        ...
        input_copylight = file.split(',')[-2]
        input_license = file.split(',')[-1]
        _check_only_file_mode = True

    if auto_mode != "" and _check_only_file_mode is False:
        input_copylight = auto_mode.split(',')[0]
        input_license = auto_mode.split(',')[1]
        _auto_add_mode = True
