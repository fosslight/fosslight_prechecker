...
def prechecker_for_project(path_to_find, need_log_file):
    missing_license = []
    missing_copyright = []
...
def run_lint(target_path, disable, output_file_name, format='', need_log_file=True):
    ...
    if os.path.isdir(path_to_find):
        ...
        if _check_only_file_mode:
            license_missing_files, copyright_missing_files, project = prechecker_for_files(path_to_find, file_to_check_list)
        else:
            license_missing_files, copyright_missing_files, oss_pkg_info, project, report = prechecker_for_project(path_to_find, need_log_file)
